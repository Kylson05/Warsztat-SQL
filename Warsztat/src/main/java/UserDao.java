...
public class UserDao {
    ...
    private static final String DROP_DATABASE_IF_EXISTS = "DROP DATABAE IF EXISTS workshop2";
    private static final String CREATE_DATABASE_IF_NOT_EXIST = "CREATE DATABASE IF NOT EXISTS workshop2 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci";
    ...
    public void createDatabase() {
        try (Connection conn = DBUtil.connect()) {
            conn.createStatement().executeUpdate((CREATE_DATABASE_IF_NOT_EXIST));
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    public void updatePassword(User user, String password) {
        try (Connection conn = DBUtil.connect("workshop2")) {
            ...
            ex.printStackTrace();
            throw new DaoException("Błąd zmiany hała użytkownika", ex);
        }
    }
